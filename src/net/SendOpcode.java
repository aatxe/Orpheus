...
public enum SendOpcode {
	...
	SPAWN_PORTAL(0x43), 
	SERVERMESSAGE(0x44), 
	SOMETHING_WITH_INVENTORY(0x45), // 45
	...
	MARRIAGE_MSG(0x6A),
	JOB_MSG(0x6B), 
	BLANK_MESSAGE(0x6D), // Not blank, it's a popup.
	AVATAR_MEGA(0x6F), 
	...
	RESET_MONSTER_ANIMATION(0xF4), // Something with mob.
	DAMAGE_MONSTER(0xF6),
	ARIANT_THING(0xF9),
