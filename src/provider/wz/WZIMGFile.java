...
public class WZIMGFile {
	...
	private void parse(WZIMGEntry entry, SeekableLittleEndianAccessor slea) {
		...
		switch (marker) {
			...
			default:
				Output.print("Unknown Image identifier: " + marker + " at offset " + (slea.getPosition() - file.getOffset()));
		}
		...
		switch (marker) {
			...
			case 8:
				...
				if (iMarker == 0) {
					...
					Output.print("Unknown String type " + iMarker);
				}
				break;
			case 9:
				...
				break;
			default:
				Output.print("Unknown Image type " + marker);
		}
	}
	...
	private void parseExtended(WZIMGEntry entry, SeekableLittleEndianAccessor slea, long endOfExtendedBlock) {
		...
		if (type.equals("Property")) {
			...
			if (marker == 0) {
				...
				Output.print("Canvas marker != 1 (" + marker + ")");
			}
			...
			switch (uolmarker) {
				...
				case 1:
					...
					break;
				default:
					Output.print("Unknown UOL marker: " + uolmarker + " " + entry.getName());
			}
		} else {
